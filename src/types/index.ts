...
/**
 * Una capa dentro del listado de workspaces de una conexión (GET
 * /admin/conexiones-geoserver/:id/workspaces) — a diferencia de CapaGeoserver
 * (más abajo), no trae `tema` porque ya viaja agrupada bajo su WorkspaceOption.
 */
export interface CapaWorkspace {
  id: string
  nombre: string

...
export function SupportCTA({ onContactar }: { onContactar: () => void }) {
  return (
    ...
    >
      <div className="bg-primary-800/10 p-8 flex flex-col justify-center">
        <h3 className="font-display text-2xl font-bold text-text leading-tight mb-3">
        ...
        <div>
          <button
            onClick={onContactar}
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--card-bg)] text-primary-800 rounded-lg text-sm font-semibold hover:bg-primary-800 hover:text-white transition-colors border border-primary-800/20"
          >

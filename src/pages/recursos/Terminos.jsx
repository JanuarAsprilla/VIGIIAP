  ...
  return (
    <div className="space-y-8">
      ...
      <Card3D
        ...
        intensity={3}
        className="bg-white border border-border/70 rounded-xl p-8 max-w-3xl"
        whileHover={{ y: -2 }}
      >
        <div className="prose prose-sm max-w-none space-y-5 text-text-light leading-relaxed">
          ...
          <h3 className="text-lg font-bold text-text">4. Privacidad de Datos</h3>
          <p>Los datos personales recopilados durante el registro y uso del sistema se tratarán conforme a la Ley 1581 de 2012 de Protección de Datos Personales de Colombia.</p>

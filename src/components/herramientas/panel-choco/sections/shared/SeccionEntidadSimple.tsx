 ...
 * área/porcentaje — departamentos, cuencas, o cualquier otra categoría territorial que
 * comparta esta forma. Real DRY: la misma vista se repite tal cual en 3+ secciones. */
export default function SeccionEntidadSimple({ entidades, unidad = 'Ha', etiquetaColumnaNombre }: SeccionEntidadSimpleProps) {
  ...
  const columnas: ColumnaTabla<EntidadArea>[] = [
    ...
    {
      key: 'area', label: `Área (${unidad})`, align: 'right',
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[var(--card-bg)] border border-border rounded-xl p-5">
          <h3 className="text-sm font-bold text-text mb-3">Área por {etiquetaColumnaNombre.toLowerCase()}</h3>
